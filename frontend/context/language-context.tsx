...
const translations = {
  en: {
    ...
    appointmentSuccessMsg: "Your appointment has been confirmed.",
    ok: "OK",
    fees: "Fees",
    experience: "Experience",
    years: "Years",
    joinVideoCall: "Join Video Call",
    joinVideoCallAlert: "You can only join the call 5 minutes before the scheduled time.",
  ...
  hi: {
    ...
    appointmentSuccess: "अपॉइंटमेंट सफलतापूर्वक बुक किया गया!",
    appointmentSuccessMsg: "आपके अपॉइंटमेंट की पुष्टि हो गई है।",
    ok: "ठीक है",
    fees: "फीस",
    experience: "अनुभव",
    years: "वर्ष",
    joinVideoCall: "वीडियो कॉल से जुड़ें",
    joinVideoCallAlert: "आप निर्धारित समय से 5 मिनट पहले ही कॉल से जुड़ सकते हैं।",
